...
public sealed class EllipseGeometry : Geometry
{
   ...
   public static readonly AdamantiumProperty StopAngleProperty = AdamantiumProperty.Register(nameof(SweepAngle),
   ...
   public EllipseGeometry(Rect rect, Double startAngle = 0, Double sweepAngle = 360, EllipseType ellipseType = EllipseType.Sector) : this()
   {
      bounds = rect;
   ...
   public EllipseGeometry(Vector2 center, Double radiusX, Double radiusY, Double startAngle = 0, Double sweepAngle = 360, EllipseType ellipseType = EllipseType.Sector) : this()
   {
   ...
   private void CreateEllipse(Rect rect, GeometryType geometryType, Double startAngle = 0, Double sweepAngle = 360, EllipseType ellipseType = EllipseType.Sector)
   {
      bounds = rect;
      RadiusX = rect.Width / 2;
      RadiusY = rect.Height / 2;
   ...
   {
      CreateEllipse(Bounds, geometryType, StartAngle, SweepAngle, EllipseType);
   }
}