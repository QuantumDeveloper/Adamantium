...
namespace Adamantium.Engine.Templates.Tools
{
    public class PivotToolTemplate: BaseToolTemplate
    {
        ...
        public override Entity BuildEntity(Entity owner, string name)
        {
            ...
            var xAxisMesh = Shapes.Line.GenerateGeometry(GeometryType.Outlined, new Vector3F(axisLength/2, 0, 0), xSize, 0);
            ...
            var yAxisMesh = Shapes.Line.GenerateGeometry(GeometryType.Outlined, new Vector3F(0, axisLength/2, 0), ySize, 0);
            ...
            var zAxisMesh = Shapes.Line.GenerateGeometry(GeometryType.Outlined, new Vector3F(0, 0, axisLength/2), zSize, 0);
            ...
            var circle = Shapes.Ellipse.GenerateGeometry(GeometryType.Solid, EllipseType.EdgeToEdge, new Vector2F(axisLength / 20.0f));
            ...
            var forwardOrbit = Shapes.Ellipse.GenerateGeometry(
                ...
                new Vector2F(axisLength),
                0,
                360,
                true,
                tesselation);

            var upOrbit = forwardOrbit.Clone(Matrix4x4F.RotationX(MathHelper.DegreesToRadians(90)));
            var rightOrbit = upOrbit.Clone(Matrix4x4F.RotationZ(MathHelper.DegreesToRadians(90)));
