...
/// That is exactly the retained geometry-instancing case: the whole visible window of stars collapses to ONE instanced
/// draw (shared mesh + a per-instance world-matrix/colour SSBO) automatically, instead of one draw per star.
