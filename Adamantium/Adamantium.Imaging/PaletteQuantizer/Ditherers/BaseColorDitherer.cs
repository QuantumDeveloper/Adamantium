...
namespace Adamantium.Imaging.PaletteQuantizer.Ditherers
{
    public abstract class BaseColorDitherer : IColorDitherer
    {
        ...
        /// <summary>
        /// See <see cref="IColorDitherer.Prepare(Adamantium.Imaging.PaletteQuantizer.Quantizers.IColorQuantizer,int,Adamantium.Imaging.PaletteQuantizer.Helpers.ImageBuffer,Adamantium.Imaging.PaletteQuantizer.Helpers.ImageBuffer)"/> for more details.
        /// </summary>
