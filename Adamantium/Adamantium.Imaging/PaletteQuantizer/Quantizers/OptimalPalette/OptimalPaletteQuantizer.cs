...
using Adamantium.Imaging.PaletteQuantizer.ColorCaches;
using Adamantium.Imaging.PaletteQuantizer.ColorCaches.Octree;
using Adamantium.Mathematics;

namespace Adamantium.Imaging.PaletteQuantizer.Quantizers.OptimalPalette
{
