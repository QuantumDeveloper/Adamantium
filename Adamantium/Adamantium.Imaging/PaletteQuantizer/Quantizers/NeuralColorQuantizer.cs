...
namespace Adamantium.Imaging.PaletteQuantizer.Quantizers
{
    /// <summary>
    ...
    public class NeuralColorQuantizer : BaseColorQuantizer
    {
        ...
        /// <summary>
        /// See <see cref="BaseColorQuantizer.OnPrepare(Adamantium.Imaging.PaletteQuantizer.Helpers.ImageBuffer)"/> for more details.
        /// </summary>
        ...
        /// <summary>
        /// See <see cref="BaseColorQuantizer.OnAddColor(Color,int,int,int)"/> for more details.
        /// </summary>
        ...
        /// <summary>
        /// See <see cref="BaseColorQuantizer.OnGetPalette(int)"/> for more details.
        /// </summary>
