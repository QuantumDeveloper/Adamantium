...
using System;
using Adamantium.Imaging.Jpeg.Filter;

namespace Adamantium.Imaging.Jpeg.Resize
{
    ...
    public class ImageResizer
    {
        ...
        private ComponentsBuffer PerformResize(Filter.Filter resizeFilter, int width, int height)
        {
        ...
        private Filter.Filter GetResizeFilter(ResamplingFilters technique)
        {
            Filter.Filter resizeFilter;
            switch (technique)
            {
