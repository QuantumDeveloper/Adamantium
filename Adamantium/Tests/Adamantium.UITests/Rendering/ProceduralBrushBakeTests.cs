...
public class ProceduralBrushBakeTests
{
    ...
    public void PatternBrush_Bakes_TypeCellAndZeroNoise()
    {
        ...
        var ok = PatternRectCollector.BakeItem(Payload(brush), Matrix4x4F.Identity, 1.0, 0, -1, -1, out var item);
        Assert.Multiple(() =>
        {
    ...
    public void CellSize_ScalesByWorldDeviceScale()
    {
        ...
        PatternRectCollector.BakeItem(Payload(brush), world, 1.0, 0, -1, -1, out var item);
    ...
    public void RotatedWorld_IsRejected_ForPerUnitDraw()
    {
        ...
        var ok = PatternRectCollector.BakeItem(Payload(new PatternBrush()), rotated, 1.0, 0, -1, -1, out _);
