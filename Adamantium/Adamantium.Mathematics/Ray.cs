...
namespace Adamantium.Mathematics
{
    ...
    public struct Ray : IEquatable<Ray>, IFormattable
    {
        ...
        {
            distance = Collision.RayIntersectsLineSegment(ref this, lineStart, lineEnd, out point);
        ...
        /// <param name="worldViewProjection">Transformation <see cref="Matrix4x4F"/>.</param>
        /// <returns>Resulting <see cref="Ray"/>.</returns>
        public static Ray GetPickRay(int x, int y, ViewportF viewport, Matrix4x4F worldViewProjection)
        {
