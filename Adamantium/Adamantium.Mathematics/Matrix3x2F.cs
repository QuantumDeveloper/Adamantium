...
{
   /// <summary>
   /// Direct2D Matrix3x2F. Supports implicit cast from <see cref="Matrix4x4F"/>.
   /// </summary>
   ...
   public struct Matrix3x2F
   {
      ...
      public Matrix3x2F(float[] values)
      {
         ...
         if (values.Length != 6)
            throw new ArgumentOutOfRangeException("values", "There must be six input values for Matrix3x2F.");
      ...
      public float this[int index]
      {
         ...
         set
         {
            switch (index)
            {
               ...
               default: throw new ArgumentOutOfRangeException("index", "Indices for Matrix3x2F run from 0 to 5, inclusive.");
            }
         }
      }
      ...
      /// <summary>
      /// Performs an implicit conversion from <see cref="Matrix4x4F"/> to <see cref="Matrix3x2F"/>.
      /// </summary>
      /// <param name="matrix">The matrix.</param>
      /// <returns>The result of the conversion.</returns>
      public static implicit operator Matrix3x2F(Matrix4x4F matrix)
      {
