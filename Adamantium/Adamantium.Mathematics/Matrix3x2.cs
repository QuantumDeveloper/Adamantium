...
{
   /// <summary>
   /// Direct2D Matrix3x2. Supports implicit cast from <see cref="Matrix4x4F"/>.
   /// </summary>
   ...
   public struct Matrix3x2
   {
      ...
      public Matrix3x2(double[] values)
      {
         if (values == null)
      ...
      public static void Multiply(ref Matrix3x2 left, double right, out Matrix3x2 result)
      {
      ...
      public static Matrix3x2 Multiply(Matrix3x2 left, double right)
      {
      ...
      /// <param name="right">The amount by which to scale.</param>
      /// <param name="result">When the method completes, contains the scaled matrix.</param>
      public static void Divide(ref Matrix3x2 left, double right, out Matrix3x2 result)
      {
      ...
      /// </remarks>
      public static void Lerp(ref Matrix3x2 start, ref Matrix3x2 end, double amount, out Matrix3x2 result)
      {
      ...
      /// Passing <paramref name="amount"/> a value of 0 will cause <paramref name="start"/> to be returned; a value of 1 will cause <paramref name="end"/> to be returned. 
      /// </remarks>
      public static Matrix3x2 Lerp(Matrix3x2 start, Matrix3x2 end, double amount)
      {
      ...
      public static void SmoothStep(ref Matrix3x2 start, ref Matrix3x2 end, double amount, out Matrix3x2 result)
      {
      ...
      public static Matrix3x2 SmoothStep(Matrix3x2 start, Matrix3x2 end, double amount)
      {
      ...
      /// <param name="result">When the method completes, contains the created scaling matrix.</param>
      public static void Scaling(double x, double y, out Matrix3x2 result)
      {
         result = Identity;
         result.M11 = x;
         result.M22 = y;
      ...
      /// <param name="y">Scaling factor that is applied along the y-axis.</param>
      /// <returns>The created scaling matrix.</returns>
      public static Matrix3x2 Scaling(double x, double y)
      {
      ...
      /// <param name="result">When the method completes, contains the created scaling matrix.</param>
      public static void Scaling(double scale, out Matrix3x2 result)
      {
      ...
      /// <param name="scale">The uniform scale that is applied along both axes.</param>
      /// <returns>The created scaling matrix.</returns>
      public static Matrix3x2 Scaling(double scale)
      {
      ...
      public static void Rotation(double angle, out Matrix3x2 result)
      {
      ...
      public static Matrix3x2 Rotation(double angle)
      {
      ...
      public static void Transformation(double xScale, double yScale, double angle, double xOffset, double yOffset, out Matrix3x2 result)
      {
      ...
      public static Matrix3x2 Transformation(double xScale, double yScale, double angle, double xOffset, double yOffset)
      {
      ...
      /// <param name="result">When the method completes, contains the created translation matrix.</param>
      public static void Translation(double x, double y, out Matrix3x2 result)
      {
         result = Identity;
         result.M31 = x;
         result.M32 = y;
      ...
      /// <param name="y">Y-coordinate offset.</param>
      /// <returns>The created translation matrix.</returns>
      public static Matrix3x2 Translation(double x, double y)
      {
      ...
      public static Matrix3x2 Skew(double angleX, double angleY)
      {
      ...
      public static void Skew(double angleX, double angleY, out Matrix3x2 result)
      {
      ...
      public static void Invert(ref Matrix3x2 value, out Matrix3x2 result)
      {
         ...
         double offsetX = value.M31;
         double offsetY = value.M32;

         result = new Matrix3x2(
             value.M22 * inverseDeterminant,
             -value.M12 * inverseDeterminant,
             -value.M21 * inverseDeterminant,
             value.M11 * inverseDeterminant,
             (value.M21 * offsetY - offsetX * value.M22) * inverseDeterminant,
             (offsetX * value.M12 - value.M11 * offsetY) * inverseDeterminant);
      }
      ...
      /// <returns>The scaled matrix.</returns>
      public static Matrix3x2 operator *(double left, Matrix3x2 right)
      {
      ...
      /// <param name="right">The amount by which to scale.</param>
      /// <returns>The scaled matrix.</returns>
      public static Matrix3x2 operator *(Matrix3x2 left, double right)
      {
         Multiply(ref left, right, out var result);
         return result;
      }
      ...
      {
         if (value is not Matrix3x2 strongValue)
            return false;
      ...
      /// <summary>
      /// Performs an implicit conversion from <see cref="Matrix4x4F"/> to <see cref="Matrix3x2"/>.
      /// </summary>
      /// <param name="matrix">The matrix.</param>
      /// <returns>The result of the conversion.</returns>
      public static implicit operator Matrix3x2(Matrix4x4F matrix)
      {
         return new()
         {
            M11 = matrix.M11,
