...
namespace Adamantium.Mathematics
{
   ...
   public static class Collision
   {
      ...
      public static void ClosestPointBoxPoint(ref BoundingBox box, ref Vector3F point, out Vector3F result)
      {
         ...
         Vector3F temp;
         Vector3F.Max(ref point, ref box.Minimum, out temp);
         Vector3F.Min(ref temp, ref box.Maximum, out result);
      }
      ...
      public static bool RayIntersectsPoint(ref Ray ray, ref Vector3F point)
      {
         ...
         float c = Vector3F.Dot(m, m) - MathHelper.ZeroToleranceF;
      ...
      /// <param name="vertex3">The third vertex of the triangle to test.</param>
      /// <returns>Whether the two objects intersected.</returns>
      public static bool BoxIntersectsTriangle(ref BoundingBox box, ref Vector3F vertex1, ref Vector3F vertex2, ref Vector3F vertex3)
      {
      ...
      */
      ...
      /// <param name="sphere">The sphere to test.</param>
      /// <returns>Whether the two objects intersected.</returns>
      public static bool BoxIntersectsSphere(ref OrientedBoundingBox box, ref BoundingSphere sphere)
      {
         //Source: Real-Time Collision Detection by Christer Ericson
         //Reference: Page 166
      ...
      /// <param name="vertex3">The third vertex of the triangle to test.</param>
      /// <returns>The type of containment the two objects have.</returns>
      public static ContainmentType BoxContainsTriangle(ref BoundingBox box, ref Vector3F vertex1, ref Vector3F vertex2, ref Vector3F vertex3)
      {
