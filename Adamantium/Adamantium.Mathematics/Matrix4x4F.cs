...
namespace Adamantium.Mathematics
{
    ...
    {
        /// <summary>
        /// The size of the <see cref="Matrix4x4F"/> type, in bytes.
        /// </summary>
        public static readonly int SizeInBytes = 4 * 4 * sizeof(float);

        /// <summary>
        /// A <see cref="Matrix4x4F"/> with all of its components set to zero.
        /// </summary>
        public static readonly Matrix4x4F Zero;

        /// <summary>
        /// The identity <see cref="Matrix4x4F"/>.
        /// </summary>
        public static readonly Matrix4x4F Identity = new Matrix4x4F() { M11 = 1.0f, M22 = 1.0f, M33 = 1.0f, M44 = 1.0f };
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Matrix4x4F"/> struct.
        /// </summary>
        ...
        public Matrix4x4F(float[] values)
        {
            ...
            if (values.Length < 16)
                throw new ArgumentOutOfRangeException(nameof(values), "There must be sixteen and only sixteen input values for Matrix4x4F.");
        ...
        public float this[int index]
        {
            get
            {
                ...
                throw new ArgumentOutOfRangeException("index", "Indices for Matrix4x4F run from 0 to 15, inclusive.");
            }
            ...
            set
            {
                switch (index)
                {
                    ...
                    default: throw new ArgumentOutOfRangeException("index", "Indices for Matrix4x4F run from 0 to 15, inclusive.");
                }
            }
        }
        ...
        public void DecomposeQR(out Matrix4x4F Q, out Matrix4x4F R)
        {
        ...
        /// <param name="Q">When the method completes, contains the orthonormalized matrix of the decomposition.</param>
        public void DecomposeLQ(out Matrix4x4F L, out Matrix4x4F Q)
        {
        ...
        public static void Add(ref Matrix4x4F left, ref Matrix4x4F right, out Matrix4x4F result)
        {
        ...
        public static void Subtract(ref Matrix4x4F left, ref Matrix4x4F right, out Matrix4x4F result)
        {
            result.M11 = left.M11 - right.M11;
            result.M12 = left.M12 - right.M12;
            result.M13 = left.M13 - right.M13;
        ...
        public static void Multiply(ref Matrix4x4F left, float right, out Matrix4x4F result)
        {
        ...
        public static void Multiply(ref Matrix4x4F left, ref Matrix4x4F right, out Matrix4x4F result)
        {
        ...
        /// <param name="right">The amount by which to scale.</param>
        /// <param name="result">When the method completes, contains the scaled matrix.</param>
        public static void Divide(ref Matrix4x4F left, float right, out Matrix4x4F result)
        {
        ...
        /// <param name="right">The amount by which to scale.</param>
        /// <returns>The scaled matrix.</returns>
        public static Matrix4x4F Divide(Matrix4x4F left, float right)
        {
            Matrix4x4F result;
        ...
        public static void Divide(ref Matrix4x4F left, ref Matrix4x4F right, out Matrix4x4F result)
        {
            result.M11 = left.M11 / right.M11;
            result.M12 = left.M12 / right.M12;
            result.M13 = left.M13 / right.M13;
        ...
        public static Matrix4x4F Divide(Matrix4x4F left, Matrix4x4F right)
        {
            Matrix4x4F result;
        ...
        public static void Exponent(ref Matrix4x4F value, int exponent, out Matrix4x4F result)
        {
            //Source: http://rosettacode.org
            //Reference: http://rosettacode.org/wiki/Matrix4x4F-exponentiation_operator
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">Thrown when the <paramref name="exponent"/> is negative.</exception>
        public static Matrix4x4F Exponent(Matrix4x4F value, int exponent)
        {
            Matrix4x4F result;
        ...
        public static void Negate(ref Matrix4x4F value, out Matrix4x4F result)
        {
        ...
        /// </remarks>
        public static void Lerp(ref Matrix4x4F start, ref Matrix4x4F end, float amount, out Matrix4x4F result)
        {
        ...
        /// Passing <paramref name="amount"/> a value of 0 will cause <paramref name="start"/> to be returned; a value of 1 will cause <paramref name="end"/> to be returned. 
        /// </remarks>
        public static Matrix4x4F Lerp(Matrix4x4F start, Matrix4x4F end, float amount)
        {
            Matrix4x4F result;
        ...
        public static void SmoothStep(ref Matrix4x4F start, ref Matrix4x4F end, float amount, out Matrix4x4F result)
        {
        ...
        public static Matrix4x4F SmoothStep(Matrix4x4F start, Matrix4x4F end, float amount)
        {
            Matrix4x4F result;
        ...
        public static void Transpose(ref Matrix4x4F value, out Matrix4x4F result)
        {
            Matrix4x4F temp = new Matrix4x4F();
            temp.M11 = value.M11;
            temp.M12 = value.M21;
        ...
        /// <param name="value">The matrix whose transpose is to be calculated.</param>
        /// <param name="result">When the method completes, contains the transpose of the specified matrix.</param>
        public static void TransposeByRef(ref Matrix4x4F value, ref Matrix4x4F result)
        {
            result.M11 = value.M11;
        ...
        public static Matrix4x4F Transpose(Matrix4x4F value)
        {
            Matrix4x4F result;
        ...
        public static void Invert(ref Matrix4x4F value, out Matrix4x4F result)
        {
        ...
        public static Matrix4x4F Invert(Matrix4x4F value)
        {
            value.Invert();
            return value;
        }
        ...
        /// input and than transpose the output.</para>
        /// </remarks>
        public static void Orthogonalize(ref Matrix4x4F value, out Matrix4x4F result)
        {
        ...
        /// input and than transpose the output.</para>
        /// </remarks>
        public static Matrix4x4F Orthogonalize(Matrix4x4F value)
        {
            Matrix4x4F result;
        ...
        /// input and than transpose the output.</para>
        /// </remarks>
        public static void Orthonormalize(ref Matrix4x4F value, out Matrix4x4F result)
        {
            //Uses the modified Gram-Schmidt process.
        ...
        /// input and than transpose the output.</para>
        /// </remarks>
        public static Matrix4x4F Orthonormalize(Matrix4x4F value)
        {
            Matrix4x4F result;
        ...
        /// </remarks>
        public static void UpperTriangularForm(ref Matrix4x4F value, out Matrix4x4F result)
        {
        ...
        /// number of solutions exist.
        /// </remarks>
        public static Matrix4x4F UpperTriangularForm(Matrix4x4F value)
        {
            Matrix4x4F result;
        ...
        /// number of solutions exist.
        /// </remarks>
        public static void LowerTriangularForm(ref Matrix4x4F value, out Matrix4x4F result)
        {
            //Adapted from the row echelon code.
            Matrix4x4F temp = value;
            Matrix4x4F.Transpose(ref temp, out result);
            ...
            Matrix4x4F.Transpose(ref result, out result);
        }
        ...
        /// number of solutions exist.
        /// </remarks>
        public static Matrix4x4F LowerTriangularForm(Matrix4x4F value)
        {
            Matrix4x4F result;
        ...
        public static void RowEchelonForm(ref Matrix4x4F value, out Matrix4x4F result)
        {
        ...
        public static Matrix4x4F RowEchelonForm(Matrix4x4F value)
        {
            Matrix4x4F result;
        ...
        /// </remarks>
        public static void ReducedRowEchelonForm(ref Matrix4x4F value, ref Vector4F augment, out Matrix4x4F result, out Vector4F augmentResult)
        {
            //Source: http://rosettacode.org
        ...
        public static void BillboardLH(ref Vector3F objectPosition, ref Vector3F cameraPosition, ref Vector3F cameraUpVector, ref Vector3F cameraForwardVector, out Matrix4x4F result)
        {
            Vector3F crossed;
            Vector3F final;
        ...
        public static Matrix4x4F BillboardLH(Vector3F objectPosition, Vector3F cameraPosition, Vector3F cameraUpVector, Vector3F cameraForwardVector)
        {
            Matrix4x4F result;
        ...
        /// <param name="cameraForwardVector">The forward vector of the camera.</param>
        /// <param name="result">When the method completes, contains the created billboard matrix.</param>
        public static void BillboardRH(ref Vector3F objectPosition, ref Vector3F cameraPosition, ref Vector3F cameraUpVector, ref Vector3F cameraForwardVector, out Matrix4x4F result)
        {
            Vector3F crossed;
            Vector3F final;
        ...
        /// <param name="cameraForwardVector">The forward vector of the camera.</param>
        /// <returns>The created billboard matrix.</returns>
        public static Matrix4x4F BillboardRH(Vector3F objectPosition, Vector3F cameraPosition, Vector3F cameraUpVector, Vector3F cameraForwardVector)
        {
            Matrix4x4F result;
        ...
        public static void LookAtLH(ref Vector3F eye, ref Vector3F target, ref Vector3F up, out Matrix4x4F result)
        {
        ...
        public static Matrix4x4F LookAtLH(Vector3F eye, Vector3F target, Vector3F up)
        {
            Matrix4x4F result;
        ...
        /// <param name="up">The camera's up vector.</param>
        /// <param name="result">When the method completes, contains the created look-at matrix.</param>
        public static void LookAtRH(ref Vector3F eye, ref Vector3F target, ref Vector3F up, out Matrix4x4F result)
        {
            Vector3F xaxis, yaxis, zaxis;
        ...
        /// <param name="up">The camera's up vector.</param>
        /// <returns>The created look-at matrix.</returns>
        public static Matrix4x4F LookAtRH(Vector3F eye, Vector3F target, Vector3F up)
        {
            Matrix4x4F result;
        ...
        /// </summary>
        /// <param name="eye">The position of the viewer's eye.</param>
        /// <param name="lookDirection">The camera look-to direction.</param>
        /// <param name="up">The camera's up vector.</param>
        /// <param name="result">When the method completes, contains the created look-at matrix.</param>
        public static void LookToLH(ref Vector3F eye, ref Vector3F lookDirection, ref Vector3F up, out Matrix4x4F result)
        {
            Vector3F xaxis, yaxis, zaxis;
            zaxis = lookDirection;
            zaxis.Normalize();
        ...
        /// </summary>
        /// <param name="eye">The position of the viewer's eye.</param>
        /// <param name="lookDirection">The camera look-at target.</param>
        /// <param name="up">The camera's up vector.</param>
        /// <returns>The created look-at matrix.</returns>
        public static Matrix4x4F LookToLH(Vector3F eye, Vector3F lookDirection, Vector3F up)
        {
            Matrix4x4F result;
        ...
        public static void OrthoLH(float width, float height, float znear, float zfar, out Matrix4x4F result)
        {
            float halfWidth = width * 0.5f;
            float halfHeight = height * 0.5f;
        ...
        public static Matrix4x4F OrthoLH(float width, float height, float znear, float zfar)
        {
            Matrix4x4F result;
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <param name="result">When the method completes, contains the created projection matrix.</param>
        public static void OrthoRH(float width, float height, float znear, float zfar, out Matrix4x4F result)
        {
            float halfWidth = width * 0.5f;
            float halfHeight = height * 0.5f;
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <returns>The created projection matrix.</returns>
        public static Matrix4x4F OrthoRH(float width, float height, float znear, float zfar)
        {
            Matrix4x4F result;
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <param name="result">When the method completes, contains the created projection matrix.</param>
        public static void OrthoOffCenterLH(float left, float right, float bottom, float top, float znear, float zfar, out Matrix4x4F result)
        {
            float zRange = 1.0f / (zfar - znear);
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <returns>The created projection matrix.</returns>
        public static Matrix4x4F OrthoOffCenterLH(float left, float right, float bottom, float top, float znear, float zfar)
        {
            Matrix4x4F result;
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <param name="result">When the method completes, contains the created projection matrix.</param>
        public static void OrthoOffCenterRH(float left, float right, float bottom, float top, float znear, float zfar, out Matrix4x4F result)
        {
            OrthoOffCenterLH(left, right, bottom, top, znear, zfar, out result);
            result.M33 *= -1.0f;
        }
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <returns>The created projection matrix.</returns>
        public static Matrix4x4F OrthoOffCenterRH(float left, float right, float bottom, float top, float znear, float zfar)
        {
            Matrix4x4F result;
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <param name="result">When the method completes, contains the created projection matrix.</param>
        public static void PerspectiveLH(float width, float height, float znear, float zfar, out Matrix4x4F result)
        {
            float halfWidth = width * 0.5f;
            float halfHeight = height * 0.5f;
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <returns>The created projection matrix.</returns>
        public static Matrix4x4F PerspectiveLH(float width, float height, float znear, float zfar)
        {
            Matrix4x4F result;
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <param name="result">When the method completes, contains the created projection matrix.</param>
        public static void PerspectiveRH(float width, float height, float znear, float zfar, out Matrix4x4F result)
        {
            float halfWidth = width * 0.5f;
            float halfHeight = height * 0.5f;
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <returns>The created projection matrix.</returns>
        public static Matrix4x4F PerspectiveRH(float width, float height, float znear, float zfar)
        {
            Matrix4x4F result;
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <param name="result">When the method completes, contains the created projection matrix.</param>
        public static void PerspectiveFovLH(float fov, float aspect, float znear, float zfar, out Matrix4x4F result)
        {
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <returns>The created projection matrix.</returns>
        public static Matrix4x4F PerspectiveFovLH(float fov, float aspect, float znear, float zfar)
        {
            Matrix4x4F result;
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <param name="result">When the method completes, contains the created projection matrix.</param>
        public static void PerspectiveFovRH(float fov, float aspect, float znear, float zfar, out Matrix4x4F result)
        {
            float yScale = (float)(1.0f / Math.Tan(fov * 0.5f));
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <returns>The created projection matrix.</returns>
        public static Matrix4x4F PerspectiveFovRH(float fov, float aspect, float znear, float zfar)
        {
            Matrix4x4F result;
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <returns>The created projection matrix.</returns>
        public static Matrix4x4F PerspectiveOffCenterLH(float left, float right, float bottom, float top, float znear, float zfar)
        {
            Matrix4x4F result;
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <param name="result">When the method completes, contains the created projection matrix.</param>
        public static void PerspectiveOffCenterRH(float left, float right, float bottom, float top, float znear, float zfar, out Matrix4x4F result)
        {
            PerspectiveOffCenterLH(left, right, bottom, top, znear, zfar, out result);
            result.M31 *= -1.0f;
            result.M32 *= -1.0f;
        ...
        /// <param name="zfar">Maximum z-value of the viewing volume.</param>
        /// <returns>The created projection matrix.</returns>
        public static Matrix4x4F PerspectiveOffCenterRH(float left, float right, float bottom, float top, float znear, float zfar)
        {
            Matrix4x4F result;
        ...
        public static Matrix4x4F IsometricProjection(float isometricScale)
        {
            ...
            var clipMatrix = OrthoLH(2 * isometricScale, 2 * isometricScale, -2 * isometricScale, 2 * isometricScale);

            return projection * clipMatrix;
        }
        ...
        public static void Scaling(ref Vector3F scale, out Matrix4x4F result)
        {
        ...
        public static Matrix4x4F Scaling(Vector3F scale)
        {
            Matrix4x4F result;
        ...
        /// <param name="result">When the method completes, contains the created scaling matrix.</param>
        public static void Scaling(float x, float y, float z, out Matrix4x4F result)
        {
            result = Matrix4x4F.Identity;
            result.M11 = x;
            result.M22 = y;
        ...
        /// <param name="result">When the method completes, contains the created scaling matrix.</param>
        public static void Scaling(float scale, out Matrix4x4F result)
        {
            result = Matrix4x4F.Identity;
        ...
        /// <param name="scale">The uniform scale that is applied along all axis.</param>
        /// <returns>The created scaling matrix.</returns>
        public static Matrix4x4F Scaling(float scale)
        {
            Matrix4x4F result;
        ...
        public static void RotationX(float angle, out Matrix4x4F result)
        {
        ...
        /// <param name="angle">Angle of rotation in radians. Angles are measured clockwise when looking along the rotation axis toward the origin.</param>
        /// <param name="result">When the method completes, contains the created rotation matrix.</param>
        public static void RotationY(float angle, out Matrix4x4F result)
        {
            float cos = (float)Math.Cos(angle);
            float sin = (float)Math.Sin(angle);
        ...
        /// <param name="angle">Angle of rotation in radians. Angles are measured clockwise when looking along the rotation axis toward the origin.</param>
        /// <param name="result">When the method completes, contains the created rotation matrix.</param>
        public static void RotationZ(float angle, out Matrix4x4F result)
        {
            float cos = (float)Math.Cos(angle);
            float sin = (float)Math.Sin(angle);
        ...
        /// <param name="angle">Angle of rotation in radians. Angles are measured clockwise when looking along the rotation axis toward the origin.</param>
        /// <param name="result">When the method completes, contains the created rotation matrix.</param>
        public static void RotationAxis(ref Vector3F axis, float angle, out Matrix4x4F result)
        {
            float x = axis.X;
            float y = axis.Y;
            float z = axis.Z;
        ...
        public static void RotationQuaternion(ref QuaternionF rotation, out Matrix4x4F result)
        {
        ...
        /// <param name="rotation">The quaternion to use to build the matrix.</param>
        /// <returns>The created rotation matrix.</returns>
        public static Matrix4x4F RotationQuaternion(QuaternionF rotation)
        {
            Matrix4x4F result;
        ...
        /// <param name="result">When the method completes, contains the created rotation matrix.</param>
        public static void RotationYawPitchRoll(float yaw, float pitch, float roll, out Matrix4x4F result)
        {
        ...
        public static void Translation(ref Vector3F value, out Matrix4x4F result)
        {
        ...
        public static Matrix4x4F Translation(Vector3F value)
        {
            Matrix4x4F result;
        ...
        /// <param name="result">When the method completes, contains the created translation matrix.</param>
        public static void Translation(float x, float y, float z, out Matrix4x4F result)
        {
            result = Matrix4x4F.Identity;
            result.M41 = x;
            result.M42 = y;
        ...
        public static void Skew(float angle, ref Vector3F rotationVec, ref Vector3F transVec, out Matrix4x4F matrix)
        {
        ...
        public static void AffineTransformation(float scaling, ref QuaternionF rotation, ref Vector3F translation, out Matrix4x4F result)
        {
        ...
        public static Matrix4x4F AffineTransformation(float scaling, QuaternionF rotation, Vector3F translation)
        {
            Matrix4x4F result;
        ...
        /// <param name="translation">The translation factor of the transformation.</param>
        /// <param name="result">When the method completes, contains the created affine transformation matrix.</param>
        public static void AffineTransformation(float scaling, ref Vector3F rotationCenter, ref QuaternionF rotation, ref Vector3F translation, out Matrix4x4F result)
        {
        ...
        /// <param name="translation">The translation factor of the transformation.</param>
        /// <returns>The created affine transformation matrix.</returns>
        public static Matrix4x4F AffineTransformation(float scaling, Vector3F rotationCenter, QuaternionF rotation, Vector3F translation)
        {
            Matrix4x4F result;
        ...
        /// <param name="translation">The translation factor of the transformation.</param>
        /// <param name="result">When the method completes, contains the created affine transformation matrix.</param>
        public static void AffineTransformation2D(float scaling, float rotation, ref Vector2F translation, out Matrix4x4F result)
        {
            result = Scaling(scaling, scaling, 1.0f) * RotationZ(rotation) * Translation((Vector3F)translation);
        }
        ...
        /// <param name="translation">The translation factor of the transformation.</param>
        /// <returns>The created affine transformation matrix.</returns>
        public static Matrix4x4F AffineTransformation2D(float scaling, float rotation, Vector2F translation)
        {
            Matrix4x4F result;
        ...
        /// <param name="translation">The translation factor of the transformation.</param>
        /// <param name="result">When the method completes, contains the created affine transformation matrix.</param>
        public static void AffineTransformation2D(float scaling, ref Vector2F rotationCenter, float rotation, ref Vector2F translation, out Matrix4x4F result)
        {
            result = Scaling(scaling, scaling, 1.0f) * Translation((Vector3F)(-rotationCenter)) * RotationZ(rotation) *
                Translation((Vector3F)rotationCenter) * Translation((Vector3F)translation);
        }
        ...
        /// <param name="translation">The translation factor of the transformation.</param>
        /// <returns>The created affine transformation matrix.</returns>
        public static Matrix4x4F AffineTransformation2D(float scaling, Vector2F rotationCenter, float rotation, Vector2F translation)
        {
            Matrix4x4F result;
        ...
        public static void Transformation(ref Vector3F scalingCenter, ref QuaternionF scalingRotation, ref Vector3F scaling, ref Vector3F rotationCenter, ref QuaternionF rotation, ref Vector3F translation, out Matrix4x4F result)
        {
            Matrix4x4F sr = RotationQuaternion(scalingRotation);
        ...
        public static Matrix4x4F Transformation(Vector3F scalingCenter, QuaternionF scalingRotation, Vector3F scaling, Vector3F rotationCenter, QuaternionF rotation, Vector3F translation)
        {
            Matrix4x4F result;
        ...
        /// <param name="translation">The translation factor of the transformation.</param>
        /// <param name="result">When the method completes, contains the created transformation matrix.</param>
        public static void Transformation2D(ref Vector2F scalingCenter, float scalingRotation, ref Vector2F scaling, ref Vector2F rotationCenter, float rotation, ref Vector2F translation, out Matrix4x4F result)
        {
            result = Translation((Vector3F)(-scalingCenter)) * RotationZ(-scalingRotation) * Scaling((Vector3F)scaling) * RotationZ(scalingRotation) * Translation((Vector3F)scalingCenter) *
                Translation((Vector3F)(-rotationCenter)) * RotationZ(rotation) * Translation((Vector3F)rotationCenter) * Translation((Vector3F)translation);
        ...
        /// <param name="translation">The translation factor of the transformation.</param>
        /// <returns>The created transformation matrix.</returns>
        public static Matrix4x4F Transformation2D(Vector2F scalingCenter, float scalingRotation, Vector2F scaling, Vector2F rotationCenter, float rotation, Vector2F translation)
        {
            Matrix4x4F result;
        ...
        /// <summary>
        /// Determines whether the specified <see cref="Matrix4x4F"/> is equal to this instance.
        /// </summary>
        /// <param name="other">The <see cref="Matrix4x4F"/> to compare with this instance.</param>
        /// <returns>
        /// <c>true</c> if the specified <see cref="Matrix4x4F"/> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
        public bool Equals(ref Matrix4x4F other)
        {
        ...
        public override bool Equals(object value)
        {
            ...
            var strongValue = (Matrix4x4F)value;
