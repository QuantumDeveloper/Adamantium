...
namespace Adamantium.Mathematics
{
   public struct Vector4
   {
      ...
      public Vector4(Vector3 vector, double value)
      {
         X = vector.X;
         Y = vector.Y;
         Z = vector.Z;
      ...
      public Vector4(Vector2 vector, double z, double w)
      {
         X = vector.X;
         Y = vector.Y;
         Z = z;
      ...
      public Vector4(double[] values)
      {
         ...
         if (values.Length != 4)
            throw new ArgumentOutOfRangeException(nameof(values), "There must be four and only four input values for Vector4D.");
      ...
      public double this[int index]
      {
         ...
         set
         {
            switch (index)
            {
               ...
               default: throw new ArgumentOutOfRangeException("index", "Indices for Vector4D run from 0 to 3, inclusive.");
            }
         }
      }
      ...
      public static void Add(ref Vector4 left, ref double right, out Vector4 result)
      {
      ...
      public static Vector4 Add(Vector4 left, double right)
      {
      ...
      public static void Subtract(ref Vector4 left, ref double right, out Vector4 result)
      {
         result = new Vector4(left.X - right, left.Y - right, left.Z - right, left.W - right);
      }
      ...
      public static Vector4 Subtract(Vector4 left, double right)
      {
         return new Vector4(left.X - right, left.Y - right, left.Z - right, left.W - right);
      }
      ...
      /// <param name="result">The vector with subtracted scalar for each element.</param>
      public static void Subtract(ref double left, ref Vector4 right, out Vector4 result)
      {
      ...
      /// <param name="right">The input vector.</param>
      /// <returns>The vector with subtracted scalar for each element.</returns>
      public static Vector4 Subtract(double left, Vector4 right)
      {
      ...
      public static void Multiply(ref Vector4 value, double scale, out Vector4 result)
      {
      ...
      public static Vector4 Multiply(Vector4 value, double scale)
      {
      ...
      /// <param name="scale">The amount by which to scale the vector.</param>
      /// <param name="result">When the method completes, contains the scaled vector.</param>
      public static void Divide(ref Vector4 value, double scale, out Vector4 result)
      {
         result = new Vector4(value.X / scale, value.Y / scale, value.Z / scale, value.W / scale);
      }
      ...
      /// <param name="scale">The amount by which to scale the vector.</param>
      /// <returns>The scaled vector.</returns>
      public static Vector4 Divide(Vector4 value, double scale)
      {
         return new Vector4(value.X / scale, value.Y / scale, value.Z / scale, value.W / scale);
      }
      ...
      /// <param name="value">The vector to scale.</param>
      /// <param name="result">When the method completes, contains the scaled vector.</param>
      public static void Divide(double scale, ref Vector4 value, out Vector4 result)
      {
      ...
      /// <param name="scale">The amount by which to scale the vector.</param>
      /// <returns>The scaled vector.</returns>
      public static Vector4 Divide(double scale, Vector4 value)
      {
      ...
      /// <remarks>
      /// <see cref="Vector4.DistanceSquared(ref Vector4, refVector4D, out double)"/> may be preferred when only the relative distance is needed
      /// and speed is of the essence.
      /// </remarks>
      ...
      /// <remarks>
      /// <see cref="Vector4.DistanceSquaredVector4D,Vector4D)"/> may be preferred when only the relative distance is needed
      /// and speed is of the essence.
      /// </remarks>
      ...
      public static void Transform(ref Vector4 vector, ref QuaternionF rotation, out Vector4 result)
      {
      ...
      public static Vector4 Transform(Vector4 vector, QuaternionF rotation)
      {
         Vector4 result;
      ...
      /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
      /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
      public static void Transform(Vector4[] source, ref QuaternionF rotation, Vector4[] destination)
      {
         if (source == null)
            throw new ArgumentNullException(nameof(source));
         if (destination == null)
      ...
      /// <summary>
      /// Transforms a 4D vector by the given <see cref="Matrix4x4F"/>.
      /// </summary>
      /// <param name="vector">The source vector.</param>
      /// <param name="transform">The transformation <see cref="Matrix4x4F"/>.</param>
      /// <param name="result">When the method completes, contains the transformed <see cref="Vector4"/>.</param>
      public static void Transform(ref Vector4 vector, ref Matrix4x4F transform, out Vector4 result)
      {
         result = new Vector4(
      ...
      /// <param name="transform">The transformation <see cref="Matrix4x4F"/>.</param>
      /// <returns>The transformed <see cref="Vector4"/>.</returns>
      public static Vector4 Transform(Vector4 vector, Matrix4x4F transform)
      {
         Vector4 result;
      ...
      /// <summary>
      /// Transforms an array of 4D vectors by the given <see cref="Matrix4x4F"/>.
      /// </summary>
      /// <param name="source">The array of vectors to transform.</param>
      /// <param name="transform">The transformation <see cref="Matrix4x4F"/>.</param>
      /// <param name="destination">The array for which the transformed vectors are stored.
      ...
      /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
      /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
      public static void Transform(Vector4[] source, ref Matrix4x4F transform, Vector4[] destination)
      {
         if (source == null)
            throw new ArgumentNullException(nameof(source));
         if (destination == null)
      ...
      /// <param name="scale">The amount by which to scale the vector.</param>
      /// <returns>The scaled vector.</returns>
      public static Vector4 operator *(double scale, Vector4 value)
      {
         return new Vector4(value.X * scale, value.Y * scale, value.Z * scale, value.W * scale);
      }
      ...
      /// <param name="scale">The amount by which to scale the vector.</param>
      /// <returns>The scaled vector.</returns>
      public static Vector4 operator *(Vector4 value, double scale)
      {
         return new Vector4(value.X * scale, value.Y * scale, value.Z * scale, value.W * scale);
      }
