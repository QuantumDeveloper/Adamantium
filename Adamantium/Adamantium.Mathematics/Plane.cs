...
namespace Adamantium.Mathematics
{
   ...
   public struct Plane : IEquatable<Plane>, IFormattable
   {
      ...
      public void Reflection(out Matrix4x4F result)
      {
      ...
      public void Shadow(ref Vector4F light, out Matrix4x4F result)
      {
      ...
      public Matrix4x4F Shadow(Vector4F light)
      {
         Matrix4x4F result;
      ...
      /// <summary>
      /// Builds a Matrix3x3F that can be used to reflect vectors about a plane for which the reflection occurs. 
      /// This plane is assumed to be normalized
      /// </summary>
      /// <param name="result">When the method completes, contains the reflection Matrix3x3F.</param>
      public void Reflection(out Matrix3x3F result)
      {
         float x = this.Normal.X;
         float y = this.Normal.Y;
         float z = this.Normal.Z;
      ...
      /// This plane is assumed to be normalized
      /// </summary>
      /// <returns>The reflection Matrix3x3F.</returns>
      public Matrix3x3F Reflection3x3()
      {
         Matrix3x3F result;
         Reflection(out result);
         return result;
      ...
      /// <summary>
      /// Creates a Matrix3x3F that flattens geometry into a shadow.
      /// </summary>
      /// <param name="light">The light direction. If the W component is 0, the light is directional light; if the
      /// W component is 1, the light is a point light.</param>
      ...
      /// <param name="result">When the method completes, contains the shadow Matrix3x3F.</param>
      public static void Shadow(ref Vector4F light, ref Plane plane, out Matrix3x3F result)
      {
      ...
      /// W component is 1, the light is a point light.</param>
      /// <param name="plane">The plane onto which to project the geometry as a shadow. This parameter is assumed to be normalized.</param>
      /// <returns>The shadow Matrix3x3F.</returns>
      public static Matrix3x3F Shadow(Vector4F light, Plane plane)
      {
         Matrix3x3F result;
      ...
      /// <param name="result">When the method completes, contains the transformed plane.</param>
      public static void Transform(ref Plane plane, ref Matrix4x4F transformation, out Plane result)
      {
         float x = plane.Normal.X;
         float y = plane.Normal.Y;
         float z = plane.Normal.Z;
         ...
         Matrix4x4F inverse;
         Matrix4x4F.Invert(ref transformation, out inverse);
      ...
      public static Plane Transform(Plane plane, Matrix4x4F transformation)
      {
         Plane result;
         float x = plane.Normal.X;
         float y = plane.Normal.Y;
      ...
      /// <param name="transformation">The transformation matrix.</param>
      /// <exception cref="ArgumentNullException">Thrown when <paramref name="planes"/> is <c>null</c>.</exception>
      public static void Transform(Plane[] planes, ref Matrix4x4F transformation)
      {
         if (planes == null)
            throw new ArgumentNullException(nameof(planes));
      ...
      /// </summary>
      /// <param name="value">The <see cref="Plane"/> to compare with this instance.</param>
      /// <returns>
