...
namespace Adamantium.Mathematics
{
   ...
   public struct Matrix3x3D : IEquatable<Matrix3x3D>, IFormattable
   {
      ...
      /// <summary>
      /// Value at row 1 column 2 of the Matrix3x3D.
      /// </summary>
      public double M12;

      /// <summary>
      /// Value at row 1 column 3 of the Matrix3x3D.
      /// </summary>
      public double M13;

      /// <summary>
      /// Value at row 2 column 1 of the Matrix3x3D.
      /// </summary>
      public double M21;

      /// <summary>
      /// Value at row 2 column 2 of the Matrix3x3D.
      /// </summary>
      public double M22;

      /// <summary>
      /// Value at row 2 column 3 of the Matrix3x3D.
      /// </summary>
      public double M23;

      /// <summary>
      /// Value at row 3 column 1 of the Matrix3x3D.
      /// </summary>
      public double M31;

      /// <summary>
      /// Value at row 3 column 2 of the Matrix3x3D.
      /// </summary>
      public double M32;

      /// <summary>
      /// Value at row 3 column 3 of the Matrix3x3D.
      /// </summary>
      public double M33;
      ...
      /// <param name="M13">The value to assign at row 1 column 3 of the Matrix3x3D.</param>
      /// <param name="M21">The value to assign at row 2 column 1 of the Matrix3x3D.</param>
      /// <param name="M22">The value to assign at row 2 column 2 of the Matrix3x3D.</param>
      /// <param name="M23">The value to assign at row 2 column 3 of the Matrix3x3D.</param>
      ...
      public Matrix3x3D(double[] values)
      {
         ...
         if (values.Length < 9)
            throw new ArgumentOutOfRangeException(nameof(values), "There must be sixteen and only sixteen input values for Matrix3x3D.");
      ...
      /// <summary>
      /// Gets a value indicating whether this instance is an identity Matrix3x3D.
      /// </summary>
      /// <value>
      /// <c>true</c> if this instance is an identity Matrix3x3D; otherwise, <c>false</c>.
      /// </value>
      ...
      /// </summary>
      /// <value>The value of the Matrix3x3D component, depending on the index.</value>
      ...
      public double this[int index]
      {
         get
         {
            ...
            throw new ArgumentOutOfRangeException("index", "Indices for Matrix3x3D run from 0 to 8, inclusive.");
         }
         ...
         set
         {
            switch (index)
            {
               ...
               default: throw new ArgumentOutOfRangeException("index", "Indices for Matrix3x3D run from 0 to 8, inclusive.");
            }
         }
      }
      ...
      /// </summary>
      /// <value>The value of the Matrix3x3D component, depending on the index.</value>
      /// <param name="row">The row of the Matrix3x3D to access.</param>
      /// <param name="column">The column of the Matrix3x3D to access.</param>
      /// <returns>The value of the component at the specified index.</returns>
      ...
      /// <summary>
      /// Calculates the determinant of the Matrix3x3D.
      /// </summary>
      /// <returns>The determinant of the Matrix3x3D.</returns>
      ...
      /// <summary>
      /// Orthogonalizes the specified Matrix3x3D.
      /// </summary>
      /// <remarks>
      /// <para>Orthogonalization is the process of making all rows orthogonal to each other. This
      /// means that any given row in the Matrix3x3D will be orthogonal to any other given row in the
      /// Matrix3x3D.</para>
      /// <para>Because this method uses the modified Gram-Schmidt process, the resulting Matrix3x3D
      /// tends to be numerically unstable. The numeric stability decreases according to the rows
      /// so that the first row is the most stable and the last row is the least stable.</para>
      /// <para>This operation is performed on the rows of the Matrix3x3D rather than the columns.
      ...
      /// <summary>
      /// Orthonormalizes the specified Matrix3x3D.
      /// </summary>
      /// <remarks>
      ...
      /// <summary>
      /// Decomposes a Matrix3x3D into an orthonormalized Matrix3x3D Q and a right triangular Matrix3x3D R.
      /// </summary>
      ...
      /// <summary>
      /// Decomposes a Matrix3x3D into a lower triangular Matrix3x3D L and an orthonormalized Matrix3x3D Q.
      /// </summary>
      ...
      /// <summary>
      /// Decomposes a Matrix3x3D into a scale, rotation, and translation.
      /// </summary>
      /// <param name="scale">When the method completes, contains the scaling component of the decomposed Matrix3x3D.</param>
      /// <param name="rotation">When the method completes, contains the rotation component of the decomposed Matrix3x3D.</param>
      /// <remarks>
      ...
      public bool Decompose(out Vector3D scale, out QuaternionD rotation)
      {
         ...
         //If any of the scaling factors are zero, than the rotation Matrix3x3D can not exist.
      ...
      /// <summary>
      /// Exchanges two rows in the Matrix3x3D.
      /// </summary>
      ...
      /// <summary>
      /// Exchanges two columns in the Matrix3x3D.
      /// </summary>
      ...
      /// <summary>
      /// Creates an array containing the elements of the Matrix3x3D.
      /// </summary>
      /// <returns>A 9-element array containing the components of the Matrix3x3D.</returns>
      ...
      /// <summary>
      /// Scales a Matrix3x3D by the given value.
      /// </summary>
      ...
      /// <summary>
      /// Performs the exponential operation on a Matrix3x3D.
      /// </summary>
      /// <param name="value">The Matrix3x3D to perform the operation on.</param>
      ...
      /// </summary>
      /// <param name="start">Start Matrix3x3D.</param>
      ...
      /// <summary>
      /// Calculates the transpose of the specified Matrix3x3D.
      /// </summary>
      ...
      /// <summary>
      /// Calculates the inverse of the specified Matrix3x3D.
      /// </summary>
      ...
      /// Orthogonalizes the specified Matrix3x3D.
      /// </summary>
      /// <param name="value">The Matrix3x3D to orthogonalize.</param>
      /// <param name="result">When the method completes, contains the orthogonalized Matrix3x3D.</param>
      /// <remarks>
      /// <para>Orthogonalization is the process of making all rows orthogonal to each other. This
      /// means that any given row in the Matrix3x3D will be orthogonal to any other given row in the
      /// Matrix3x3D.</para>
      ...
      /// </summary>
      /// <param name="value">The Matrix3x3D to orthogonalize.</param>
      /// <returns>The orthogonalized Matrix3x3D.</returns>
      /// <remarks>
      /// <para>Orthogonalization is the process of making all rows orthogonal to each other. This
      /// means that any given row in the Matrix3x3D will be orthogonal to any other given row in the
      /// Matrix3x3D.</para>
      ...
      /// Orthonormalizes the specified Matrix3x3D.
      /// </summary>
      /// <param name="value">The Matrix3x3D to orthonormalize.</param>
      /// <param name="result">When the method completes, contains the orthonormalized Matrix3x3D.</param>
      /// <remarks>
      /// <para>Orthonormalization is the process of making all rows and columns orthogonal to each
      /// other and making all rows and columns of unit length. This means that any given row will
      /// be orthogonal to any other given row and any given column will be orthogonal to any other
      ...
      /// </summary>
      /// <param name="value">The Matrix3x3D to orthonormalize.</param>
      /// <returns>The orthonormalized Matrix3x3D.</returns>
      /// <remarks>
      /// <para>Orthonormalization is the process of making all rows and columns orthogonal to each
      /// other and making all rows and columns of unit length. This means that any given row will
      /// be orthogonal to any other given row and any given column will be orthogonal to any other
      ...
      /// <summary>
      /// Brings the Matrix3x3D into upper triangular form using elementary row operations.
      /// </summary>
      /// <param name="value">The Matrix3x3D to put into upper triangular form.</param>
      /// <param name="result">When the method completes, contains the upper triangular Matrix3x3D.</param>
      /// <remarks>
      /// If the Matrix3x3D is not invertible (i.e. its determinant is zero) than the result of this
      /// method may produce Single.Nan and Single.Inf values. When the Matrix3x3D represents a system
      ...
      /// </summary>
      /// <param name="value">The Matrix3x3D to put into upper triangular form.</param>
      /// <returns>The upper triangular Matrix3x3D.</returns>
      /// <remarks>
      /// If the Matrix3x3D is not invertible (i.e. its determinant is zero) than the result of this
      /// method may produce Single.Nan and Single.Inf values. When the Matrix3x3D represents a system
      /// of linear equations, than this often means that either no solution exists or an infinite
      ...
      /// <summary>
      /// Brings the Matrix3x3D into lower triangular form using elementary row operations.
      /// </summary>
      /// <param name="value">The Matrix3x3D to put into lower triangular form.</param>
      /// <param name="result">When the method completes, contains the lower triangular Matrix3x3D.</param>
      /// <remarks>
      /// If the Matrix3x3D is not invertible (i.e. its determinant is zero) than the result of this
      /// method may produce Single.Nan and Single.Inf values. When the Matrix3x3D represents a system
      /// of linear equations, than this often means that either no solution exists or an infinite
      ...
      /// </summary>
      /// <param name="value">The Matrix3x3D to put into lower triangular form.</param>
      /// <returns>The lower triangular Matrix3x3D.</returns>
      /// <remarks>
      /// If the Matrix3x3D is not invertible (i.e. its determinant is zero) than the result of this
      /// method may produce Single.Nan and Single.Inf values. When the Matrix3x3D represents a system
      /// of linear equations, than this often means that either no solution exists or an infinite
      ...
      /// <summary>
      /// Brings the Matrix3x3D into row echelon form using elementary row operations;
      /// </summary>
      ...
      /// <summary>
      /// Creates a left-handed, look-at Matrix3x3D.
      /// </summary>
      ...
      /// <summary>
      /// Creates a right-handed, look-at Matrix3x3D.
      /// </summary>
      /// <param name="eye">The position of the viewer's eye.</param>
      /// <param name="target">The camera look-at target.</param>
      /// <param name="up">The camera's up vector.</param>
      ...
      /// <summary>
      /// Creates a Matrix3x3D that scales along the x-axis, y-axis, and y-axis.
      /// </summary>
      ...
      /// <summary>
      /// Creates a Matrix3x3D that uniformly scales along all three axis.
      /// </summary>
      ...
      /// <summary>
      /// Creates a Matrix3x3D that rotates around the x-axis.
      /// </summary>
      ...
      /// <summary>
      /// Creates a Matrix3x3D that rotates around the y-axis.
      /// </summary>
      /// <param name="angle">Angle of rotation in radians. Angles are measured clockwise when looking along the rotation axis toward the origin.</param>
      /// <param name="result">When the method completes, contains the created rotation Matrix3x3D.</param>
      ...
      /// <summary>
      /// Creates a Matrix3x3D that rotates around the z-axis.
      /// </summary>
      /// <param name="angle">Angle of rotation in radians. Angles are measured clockwise when looking along the rotation axis toward the origin.</param>
      /// <param name="result">When the method completes, contains the created rotation Matrix3x3D.</param>
      ...
      /// <summary>
      /// Creates a Matrix3x3D that rotates around an arbitrary axis.
      /// </summary>
      ...
      /// <summary>
      /// Creates a rotation Matrix3x3D from a quaternion.
      /// </summary>
      ...
      /// <summary>
      /// Creates a rotation Matrix3x3D with a specified yaw, pitch, and roll.
      /// </summary>
      ...
      /// <summary>
      /// Assert a Matrix3x3D (return it unchanged).
      /// </summary>
      ...
      /// <summary>
      /// Scales a Matrix3x3D by a given value.
      /// </summary>
