...
public class GeometrySegment
{
    ...
    public GeometrySegment(GeometryIntersection end1, GeometryIntersection end2)
    {
    ...
    public GeometrySegment(Vector2 point1, Vector2 point2)
    {
    ...
    {
        if (Parent.Segments.Contains(this)) Parent.Segments.Remove(this);
    }
