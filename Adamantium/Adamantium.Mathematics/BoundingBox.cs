...
namespace Adamantium.Mathematics
{
   ...
   public struct BoundingBox : IEquatable<BoundingBox>, IFormattable
   {
      ...
      */
      ...
      {
         result.Minimum = new Vector3F(
            sphere.Center.X - sphere.Radius,
            sphere.Center.Y - sphere.Radius,
            sphere.Center.Z - sphere.Radius);
         result.Maximum = new Vector3F(
            sphere.Center.X + sphere.Radius,
            sphere.Center.Y + sphere.Radius,
            sphere.Center.Z + sphere.Radius);
      }
      ...
      {
         BoundingBox box;
         box.Minimum = new Vector3F(
            sphere.Center.X - sphere.Radius,
            sphere.Center.Y - sphere.Radius,
            sphere.Center.Z - sphere.Radius);
         box.Maximum = new Vector3F(
            sphere.Center.X + sphere.Radius,
            sphere.Center.Y + sphere.Radius,
            sphere.Center.Z + sphere.Radius);
         return box;
      ...
      {
         Vector3F.Min(ref value1.Minimum, ref value2.Minimum, out result.Minimum);
         Vector3F.Max(ref value1.Maximum, ref value2.Maximum, out result.Maximum);
      }
      ...
      {
         BoundingBox box;
         Vector3F.Min(ref value1.Minimum, ref value2.Minimum, out box.Minimum);
         Vector3F.Max(ref value1.Maximum, ref value2.Maximum, out box.Maximum);
         return box;
      }
      ...
      /// <returns>
      /// <c>true</c> if the specified <see cref="BoundingBox"/> is equal to this instance; otherwise, <c>false</c>.
      /// </returns>
      [MethodImpl(MethodImplOptions.AggressiveInlining)]
