...
namespace Adamantium.Mathematics
{
   ...
   public struct Vector4F : IEquatable<Vector4F>, IFormattable
   {
      ...
      public Vector4F(Vector3F vector, float value)
      {
         X = vector.X;
         Y = vector.Y;
         Z = vector.Z;
      ...
      public Vector4F(Vector2F vector)
      {
         X = vector.X;
         Y = vector.Y;
         Z = W = 0;
      ...
      public Vector4F(float[] values)
      {
         ...
         if (values.Length != 4)
            throw new ArgumentOutOfRangeException("values", "There must be four and only four input values for Vector4F.");
      ...
      public float this[int index]
      {
         ...
         set
         {
            switch (index)
            {
               ...
               default: throw new ArgumentOutOfRangeException("index", "Indices for Vector4F run from 0 to 3, inclusive.");
            }
         }
      }
      ...
      public static void Transform(ref Vector4F vector, ref QuaternionF rotation, out Vector4F result)
      {
      ...
      /// <param name="result">When the method completes, contains the transformed <see cref="Vector4F"/>.</param>
      public static void Transform(ref Vector4F vector, ref Matrix4x4F transform, out Vector4F result)
      {
         result = new Vector4F(
      ...
      /// <param name="transform">The transformation <see cref="Matrix4x4F"/>.</param>
      /// <returns>The transformed <see cref="Vector4F"/>.</returns>
      public static Vector4F Transform(Vector4F vector, Matrix4x4F transform)
      {
         Vector4F result;
      ...
      /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
      /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
      public static void Transform(Vector4F[] source, ref Matrix4x4F transform, Vector4F[] destination)
      {
         if (source == null)
            throw new ArgumentNullException(nameof(source));
         if (destination == null)
