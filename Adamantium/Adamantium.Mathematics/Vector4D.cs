...
namespace Adamantium.Mathematics
{
   public struct Vector4D
   {
      ...
      public Vector4D(Vector3D vector, double value)
      {
         X = vector.X;
         Y = vector.Y;
         Z = vector.Z;
      ...
      public Vector4D(Vector2D vector)
      {
         X = vector.X;
         Y = vector.Y;
         Z = W = 0;
      ...
      /// <param name="result">When the method completes, contains the transformed <see cref="Vector4D"/>.</param>
      public static void Transform(ref Vector4D vector, ref Matrix4x4F transform, out Vector4D result)
      {
         result = new Vector4D(
      ...
      /// <param name="transform">The transformation <see cref="Matrix4x4F"/>.</param>
      /// <returns>The transformed <see cref="Vector4D"/>.</returns>
      public static Vector4D Transform(Vector4D vector, Matrix4x4F transform)
      {
         Vector4D result;
      ...
      /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
      /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
      public static void Transform(Vector4D[] source, ref Matrix4x4F transform, Vector4D[] destination)
      {
         if (source == null)
            throw new ArgumentNullException(nameof(source));
         if (destination == null)
