...
{
    /// <summary>
    /// Calculates a control's size based on its <see cref="MeasurableComponent.Width"/>,
    /// <see cref="MeasurableComponent.Height"/>, <see cref="MeasurableComponent.MinWidth"/>,
    /// <see cref="MeasurableComponent.MaxWidth"/>, <see cref="MeasurableComponent.MinHeight"/> and
    /// <see cref="MeasurableComponent.MaxHeight"/>.
    /// </summary>
    /// <param name="element">The control.</param>
    /// <param name="constraints">The space available for the control.</param>
    /// <returns>The control's size.</returns>
    public static Size ApplyLayoutConstraints(this MeasurableComponent element, Size constraints)
    {
