...
{
   public class DependencyComponent: DispatcherComponent, IAdamantiumObject
   {
      private readonly Dictionary<AdamantiumProperty, object> values = new Dictionary<AdamantiumProperty, object>();

      private DependencyComponent inheritanceParent;
      ...
      public DependencyComponent()
      {
         ...
         foreach (var property in list)
         {
            ...
            var e = new AdamantiumPropertyChangedEventArgs(property, AdamantiumProperty.UnsetValue, value.DefaultValue);
      ...
      /// </summary>
      IAdamantiumObject IAdamantiumObject.InheritanceParent => InheritanceParent;
      ...
      protected void RaisePropertyChanged(AdamantiumProperty property, object oldValue, object newValue)
      {
         ...
         AdamantiumPropertyChangedEventArgs e = new AdamantiumPropertyChangedEventArgs(property, oldValue, newValue);
      ...
      private void ParentPropertyChanged(object sender, AdamantiumPropertyChangedEventArgs e)
      {
         ...
         var metada = e.Property.GetDefaultMetadata(GetType());
         if (metada != null)
         {
            if (metada.Inherits && !IsSet(e.Property))
            {
      ...
      /// </value>
      public DependencyComponent InheritanceParent
      {
