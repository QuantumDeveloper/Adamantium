...
{
    /// <summary>
    /// A simple AST (abstract syntax tree) used to store technique/pass parsing result.
    /// </summary>
    internal class Ast
    {
        /// <summary>
        ...
        public class Pass : Node
        {
            ...
            public override string ToString()
            {
                return $"pass {(Name == null ? string.Empty : Name + " ")}{{...{Statements.Count} statement...}}";
            }
        }
        ...
        public class Technique : Node
        {
            ...
            public override string ToString()
            {
                return $"technique {(Name == null ? string.Empty : Name + " ")}{{...{Passes.Count} pass...}}";
            }
        }
