...
namespace Adamantium.Engine.Compiler.Converter.ConversionUtils
{
    internal struct Vertex : IEquatable<Vertex>
   {
      ...
      {
         return Position.Equals(vertex.Position) && UV0.Equals(vertex.UV0) &&
                UV1.Equals(vertex.UV1) && UV2.Equals(vertex.UV2) && UV3.Equals(vertex.UV3) && Color.Equals(vertex.Color)
                && JointIndex.Equals(vertex.JointIndex) && JointWeight.Equals(vertex.JointWeight);
      }
