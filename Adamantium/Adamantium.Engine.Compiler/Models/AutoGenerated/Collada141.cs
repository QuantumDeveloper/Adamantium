...
namespace Adamantium.Engine.Compiler.Converter.AutoGenerated
{
    // 
...
//    [DebuggerStepThrough]
    ...
    public class common_color_or_texture_typeColor
    {
        ...
        public string _Text_
        {
            ...
            set { Values = COLLADA.ConvertToDoubleArray(value); }
        }
    ...
    public class Name_array
    {
        ...
        /// <remarks />
        // XmlText, like every other *_array here: a Name_array holds whitespace-separated text, not <Name> child
        // elements. Bound as an element it never deserialized, Values stayed null, and the joint names had to be dug
        // out by re-reading the whole .dae with XDocument.
        [XmlText]
        public string _Text_
        {
            get { return COLLADA.ConvertFromArray(Values); }
    ...
    public class bool_array
    {
        ...
        public string _Text_
        {
            ...
            set { Values = COLLADA.ConvertToBoolArray(value); }
        }
    ...
    public class int_array
    {
        ...
        public string _Text_
        {
            ...
            set { Values = COLLADA.ConvertToIntArray(value); }
        }
    ...
    public partial class COLLADA
    {
        ...
        internal static int[] ConvertToIntArray(string arrayStr)
        {
            string[] elements = regex.Split(arrayStr.Trim());
        ...
        internal static double[] ConvertToDoubleArray(string arrayStr)
        {
            string[] elements = regex.Split(arrayStr.Trim());
      ...
      internal static float[] ConvertToFloatArray(string arrayStr)
      {
         string[] elements = regex.Split(arrayStr.Trim());
      ...
      internal static bool[] ConvertToBoolArray(string arrayStr)
        {
            string[] elements = regex.Split(arrayStr.Trim());
        ...
        public static COLLADA Load(string fileName)
        {
           ...
           {
              COLLADA result = Load(stream);
              return result;
           }
        }

        private static COLLADA Load(Stream stream)
        {
