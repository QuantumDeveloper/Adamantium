...
namespace Adamantium.Engine.Core
{
   ...
   public interface IDrawable
   {
      ...
      /// <summary>
      /// Occurs when the <see cref="IsVisible"/> property changes.
      /// </summary>
      event EventHandler<StateEventArgs> VisibilityChanged;

      /// <summary>
      /// Occurs when the <see cref="DrawPriority"/> property changes.
      /// </summary>
      event EventHandler<PriorityEventArgs> DrawPriorityChanged;

      /// <summary>
      /// Occurs when the <see cref="DrawExecutionType"/> property changes.
      /// </summary>
      event EventHandler<ExecutionTypeEventArgs> DrawExecutionTypeChanged;
   }
}
