...
namespace Adamantium.Engine.Graphics.Fonts
{
    public class TextRenderingParameters : IEquatable<TextRenderingParameters>
    {
        ...
        public bool Equals(TextRenderingParameters other)
        {
            ...
            return TextArea.Equals(other.TextArea) && TextWrapping == other.TextWrapping &&
                   HorizontalTextAlignment == other.HorizontalTextAlignment && TextTrimming == other.TextTrimming &&
        ...
        {
            return HashCode.Combine(TextArea, (int)TextWrapping, (int)HorizontalTextAlignment, (int)TextTrimming, Color);
        }
