...
namespace Adamantium.Engine.Graphics.Imaging.PaletteQuantizer.Quantizers.Octree
{
    internal class OctreeNode
    {
        ...
        public Boolean IsLeaf => pixelCount > 0;
        ...
        public Color Color
        {
            get
            {
                ...
                {
                    result = pixelCount == 1 ? 
                        Color.FromRgba(red, green, blue, 255) : 
                        Color.FromRgba((byte)(red/pixelCount), (byte)(green/pixelCount), (byte)(blue/pixelCount), 255);
                }
                else
                {
