...
using Adamantium.Engine.Graphics.Imaging.PaletteQuantizer.ColorCaches;
using Adamantium.Engine.Graphics.Imaging.PaletteQuantizer.ColorCaches.Octree;
using Adamantium.Mathematics;

namespace Adamantium.Engine.Graphics.Imaging.PaletteQuantizer.Quantizers.OptimalPalette
{
    public class OptimalPaletteQuantizer : BaseColorCacheQuantizer
    {
        ...
        private static void Register(byte red, byte green, byte blue)
        {
