...
namespace Adamantium.Engine.Graphics.Imaging.PaletteQuantizer.Quantizers.XiaolinWu
{
    /// <summary>
    /// Author:	Xiaolin Wu
    ...
    public class WuColorQuantizer : BaseColorQuantizer
    {
        ...
        protected override void OnAddColor(Color color, Int32 key, Int32 x, Int32 y)
        {
            ...
            pixels[pixelIndex] = color.ToRgba();
            pixelIndex++;
        }
        ...
        protected override List<Color> OnGetPalette(Int32 colorCount)
        {
            ...
            for (Int32 index = 0; index < imageSize; index++)
            {
                Color color = Color.FromRgba(pixels[index]);
            ...
            for (Int32 paletteIndex = 0; paletteIndex < colorCount; paletteIndex++)
            {
                ...
                Color color = Color.FromRgba((byte)reds[paletteIndex], (byte)greens[paletteIndex], (byte)blues[paletteIndex], 255);
                result.Add(color);
            }
