...
namespace Adamantium.Core.Collections
{
    ...
    public abstract class EffectResourcesCollection<T> : IEnumerable<T> where T : NamedObject
    {
        ...
        /// Constructor
        /// </summary>
        protected EffectResourcesCollection()
        {
            Items = new List<T>();
        ...
        protected EffectResourcesCollection(int capacity)
        {
