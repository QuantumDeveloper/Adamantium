...
public abstract class NamedObjectsCollection<T> : IEnumerable<T> where T : class, INamedObject
{
    ...
    /// Constructor
    /// </summary>
    protected NamedObjectsCollection()
    {
        Items = new List<T>();
    ...
    protected NamedObjectsCollection(int capacity)
    {
