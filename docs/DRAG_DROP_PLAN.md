...
2. ~~**Анимация раздвигания соседей**~~ — ✅ **СДЕЛАНО.** Описание ниже — то, как оно устроено; оставлено целиком,
   потому что каждое решение здесь было выстрадано и обратные варианты выглядят соблазнительно.
